...
from models.am_simclr import AdaptiveMultiH_CLR
from simclr import AM_SimCLR
...
def main():
    ...
    model = AdaptiveMultiH_CLR(base_model=args.arch, out_dim=args.out_dim)
    ...
    with torch.cuda.device(args.gpu_index):
        am_simclr = AM_SimCLR(model=model, optimizer=optimizer, scheduler=scheduler, args=args)
        am_simclr.train(train_loader)
